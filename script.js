...
const translations = {
  de: {
    ...
    cvEducationDescription: "Studium der Angewandten Informatik mit Fokus auf Embedded Systems. Relevante Module: Mikroprozessortechnik, Digitale Systeme, Embedded Linux, Softwareentwicklung in C/C++, Echtzeitsysteme und Kommunikationsprotokolle.",
    cvEducationHighlight1: "Hardwarenahe Programmierung in C und C++",
    cvEducationHighlight2: "Mikrocontroller-Entwicklung und Peripherie-Anbindung",
    cvEducationHighlight3: "Entwicklung von Embedded-Anwendungen mit Fokus auf Zuverlässigkeit",
    ...
    cvExperience1Task1: "Entwicklung von Firmware-Komponenten für Mikrocontroller-basierte Systeme",
    cvExperience1Task2: "Implementierung von Kommunikationsprotokollen (CAN, UART, SPI)",
    cvExperience1Task3: "Debugging und Testing mit Hardware-Debuggern und Logikanalysatoren",
    cvExperience1Task4: "Code-Reviews und Dokumentation nach Entwicklungsstandards",
    ...
    cvExperience2Task1: "Entwicklung einer Steuerungssoftware für ein Embedded-System",
    cvExperience2Task2: "Anbindung von Sensoren und Aktuatoren über verschiedene Schnittstellen",
    cvExperience2Task3: "Implementierung von Fehlerbehandlung und Diagnosefunktionen",
    cvExperience2Task4: "Erstellung technischer Dokumentation und Testprotokolle",
  ...
  en: {
    ...
    cvEducationDescription: "Studies in Applied Computer Science with focus on Embedded Systems. Relevant courses: Microprocessor Technology, Digital Systems, Embedded Linux, Software Development in C/C++, Real-Time Systems, and Communication Protocols.",
    cvEducationHighlight1: "Low-level programming in C and C++",
    cvEducationHighlight2: "Microcontroller development and peripheral integration",
    cvEducationHighlight3: "Development of embedded applications with focus on reliability",
    ...
    cvExperience1Task1: "Development of firmware components for microcontroller-based systems",
    cvExperience1Task2: "Implementation of communication protocols (CAN, UART, SPI)",
    cvExperience1Task3: "Debugging and testing with hardware debuggers and logic analyzers",
    cvExperience1Task4: "Code reviews and documentation according to development standards",
    
    cvExperience2Title: "Internship Embedded Development",
    cvExperience2Date: "09/2024 - 02/2025",
    cvExperience2Company: "Industrial Company, Southern Germany",
    cvExperience2Task1: "Development of control software for an embedded system",
    cvExperience2Task2: "Integration of sensors and actuators via various interfaces",
    cvExperience2Task3: "Implementation of error handling and diagnostic functions",
    cvExperience2Task4: "Creation of technical documentation and test protocols",
